...
public abstract class DynamicClientTest implements Client{
	...
	public DynamicClientTest(String destination, String acceptorAddress, boolean pollingServiceTest) {
	...
	protected abstract PollingServiceTest createPollingService(long pollingPeriod, boolean pollingServiceTest);
		//*********************************************/
