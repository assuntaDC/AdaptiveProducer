...
public class JMXProbe {
	public static void main(String[] args) {
		...
		try {
			//ObjectName on = ObjectNameBuilder.DEFAULT.getQueueObjectName(SimpleString.toSimpleString("MessageCountTestQueue"), SimpleString.toSimpleString("MessageCountTestQueue"), RoutingType.ANYCAST);
	        
			ObjectName on = ObjectNameBuilder.create("org.apache.activemq.artemis", "0.0.0.0").getQueueObjectName(SimpleString.toSimpleString("testQueue"), SimpleString.toSimpleString("testQueue"), RoutingType.MULTICAST);
