...
set ARTEMIS_HOME="C:\Users\lorenzo\Desktop\activemq_test\apache-artemis-2.17.0"
set ARTEMIS_INSTANCE="C:\Users\lorenzo\Desktop\activemq_test\broker1"
set ARTEMIS_DATA_DIR="C:\Users\lorenzo\Desktop\activemq_test\broker1\data"
set ARTEMIS_ETC_DIR="C:\Users\lorenzo\Desktop\activemq_test\broker1\etc"
set ARTEMIS_OOME_DUMP="C:\Users\lorenzo\Desktop\activemq_test\broker1\log\oom_dump.hprof"
...
set ARTEMIS_INSTANCE_URI="file:/C:/Users/lorenzo/Desktop/activemq_test/broker1/"
set ARTEMIS_INSTANCE_ETC_URI="file:/C:/Users/lorenzo/Desktop/activemq_test/broker1/etc/"
...
rem Java Opts
IF "%JAVA_ARGS%"=="" (set JAVA_ARGS= -XX:+PrintClassHistogram  -XX:+UseG1GC -XX:+UseStringDeduplication -Xms512M -Xmx1024M -Xbootclasspath/a:%ARTEMIS_HOME%\lib\jboss-logmanager-2.1.10.Final.jar;%ARTEMIS_HOME%\lib\wildfly-common-1.5.2.Final.jar -Djava.security.auth.login.config=%ARTEMIS_ETC_DIR%\login.config -Dhawtio.disableProxy=true -Dhawtio.offline=true -Dhawtio.realm=activemq -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=%ARTEMIS_INSTANCE_ETC_URI%\jolokia-access.xml -Dartemis.instance=%ARTEMIS_INSTANCE% -Djava.rmi.server.hostname=localhost)
